...
class _UploadState extends State<Upload>
  ...
  Future captureImageWithCamera() async {
    ...
    final pickedFile = await picker.getImage(
        source: ImageSource.camera, maxHeight: 630, maxWidth: 970);
  ...
  compressPhoto() async {
    ...
    final compressedImage = File('$path/img_$postId.jpg')
      ..writeAsBytesSync(ImD.encodeJpg(imageFile, quality: 90));
  ...
  uploadAndSave() async {
    ...
    SnackBar successUpdate = SnackBar(content: Text('Upload success'));
    _scaffoldKey.currentState.showSnackBar(successUpdate);
